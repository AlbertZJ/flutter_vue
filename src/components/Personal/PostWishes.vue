...
<div >
  ...
  <el-container>
  <el-aside style="width:300px;height:850px;">

<div class="eevee"  style="position:absolute;top:10%;left:10%; ">
<div class="body">
<div class="head">
  <div class="ears">
	<div class="ear">
    ...
    <el-main class="main"  >
      <div id="editor">
        <mavon-editor style="height: 100%;width: 100%;" ref=md @imgAdd="imgAdd"
                      @imgDel="imgDel" v-model="message.mdContent"></mavon-editor>
      </div>
      <div style="display: flex;align-items: center;margin-top: 15px;justify-content: flex-end">
          <el-button type="primary" @click="saveMessage(1)">发布寄语</el-button>
      </div>
    </el-main>
  </el-container>
  </el-main>
...
<script>
    ...
    home() {
      ...
      _this.$router.replace({ path: "/home" });
            ...
            saveMessage(state) {
                if (!(isNotNullORBlank(this.message.mdContent))) {
                ...
                postRequest("/message/add", {
                    mdContent: _this.message.mdContent,
                  ...
                  //_this.$alert(resp.status);
                    ...
                    if (resp.status == 200 && resp.data.status == 'success') {
                        _this.message.id = resp.data.msg;
                    ...
                    _this.loading = false;
                    _this.$message({type: 'error', message: state == 0 ? '保存草稿失败!' : '主人寄语发布失败!'});
                })
            },
